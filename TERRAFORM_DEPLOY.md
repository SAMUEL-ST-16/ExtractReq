...
Esta es la **opción MÁS PROFESIONAL** para desplegar ExtractReq. Con **UN SOLO COMANDO** creas toda la infraestructura en DigitalOcean y despliegas la aplicación automáticamente.
...
# 3. Generar SSH key
ssh-keygen -t rsa -b 4096 -f ~/.ssh/extractreq_terraform -N ""
