# ExtractReq - Sistema de Extracción de Requisitos de Seguridad

Sistema automatizado para la extracción y clasificación de requisitos de seguridad basados en **ISO/IEC 25010** a partir de comentarios de usuarios de aplicaciones móviles, utilizando modelos **BERT** y **LLMs**.

## 🎯 Descripción del Proyecto

ExtractReq es una aplicación web completa que permite analizar comentarios de usuarios de Google Play Store y extraer requisitos de seguridad clasificados según las 6 subcaracterísticas de seguridad de la norma ISO/IEC 25010:

1. **Confidencialidad** - Protección de acceso a datos sensibles
2. **Integridad** - Prevención de modificaciones no autorizadas
3. **No Repudio** - Evidencia de acciones realizadas
4. **Responsabilidad** - Trazabilidad de acciones de usuarios
5. **Autenticidad** - Verificación de identidad
6. **Resistencia** - Capacidad de resistir ataques
...
# Modelos BERT
BINARY_MODEL_NAME=SamuelSoto7/ExtractReqV8_Binario
MULTICLASS_MODEL_NAME=SamuelSoto7/ExtractReqV2_Multiclass
...
### Modelo Binario
- **Nombre:** `SamuelSoto7/ExtractReqV8_Binario`
- **Función:** Detecta si un texto es un requisito válido
- **Arquitectura:** BERT fine-tuned

### Modelo Multiclase
- **Nombre:** `SamuelSoto7/ExtractReqV2_Multiclass`
- **Función:** Clasifica la subcaracterística de seguridad ISO 25010
- **Clases:** Confidencialidad, Integridad, No-Repudio, Responsabilidad, Autenticidad, Resistencia
...
- ✅ Implementación de estándar internacional (ISO 25010)
