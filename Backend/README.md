...
Backend API para la extracción automática de requisitos de seguridad desde comentarios de usuarios, basado en el estándar ISO 25010.

## 🚀 Características

- **Clasificación Binaria**: Detecta si un comentario es un requisito de seguridad válido
- **Clasificación Multiclase**: Clasifica requisitos en 6 subcaracterísticas de seguridad ISO 25010:
  - Autenticidad
  - Confidencialidad
  - Integridad
  - Responsabilidad
...
{
  "comment": "La app debería cifrar mis contraseñas"
}
```
...
Samuel Moya - Desarrollo de Tesis
