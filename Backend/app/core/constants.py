"""
Constants for the ExtractReq API
...
# Etiquetas del modelo multiclase (subcaracterísticas de seguridad ISO 25010)
# El modelo multiclase predice cuál subcaracterística de seguridad es
SECURITY_SUBCHARACTERISTICS = [
...
API_TAGS_METADATA = [
    {
        ...
        "description": "Endpoints para extracción y clasificación de requisitos de seguridad"
    },
    {
        "name": "Health",
