"""
Configuration management for ExtractReq Backend
...
class Settings(BaseSettings):
    ...
    # API Configuration
    API_TITLE: str = "ExtractReq API"
    API_DESCRIPTION: str = "API para extracción de requisitos de seguridad desde comentarios de usuarios"
