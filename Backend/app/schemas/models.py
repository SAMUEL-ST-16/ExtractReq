"""
Pydantic models for ExtractReq Backend
...
class SecuritySubcharacteristic(str, Enum):
    """
    ISO 25010 Security Subcharacteristics
    """
...
class RequirementResult(BaseModel):
    ...
    subcharacteristic: Optional[str] = Field(
        None,
        description="Security subcharacteristic (if valid requirement)"
    )
