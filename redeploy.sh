#!/bin/bash
#
# 🔄 Script de Re-Despliegue Rápido - ExtractReq
...
╔══════════════════════════════════════════════════╗
║                                                  ║
║   🔄 ExtractReq - Re-Despliegue Rápido          ║
║                                                  ║
╚══════════════════════════════════════════════════╝
EOF
echo -e "${NC}"
...
echo -e "   ${CYAN}ssh -i ~/.ssh/extractreq_terraform root@$DROPLET_IP${NC}"
echo ""
...
echo -e "   ${CYAN}cat /var/log/extractreq-post-boot.log${NC}"
echo ""
echo "   Debes ver:"
