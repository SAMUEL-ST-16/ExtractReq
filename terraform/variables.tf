# Variables de Terraform para ExtractReq
...
variable "droplet_size" {
  ...
  type        = string
  default     = "s-1vcpu-1gb"  # $6/mes - suficiente para tesis
