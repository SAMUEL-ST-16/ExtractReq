...
2. Nombre del repo: `ExtractReq`
3. Descripción: `Sistema de Extracción de Requisitos de Seguridad con IA`
...
1. Crea repo: `ExtractReq-Backend` (Public)
2. Crea repo: `ExtractReq-Frontend` (Public)
...
cd "C:\Users\SAMUEL\Documents\XII CICLO\Desarrollo de Tesis Final\ExtractReq"
...
git commit -m "Initial commit - ExtractReq with Terraform deployment"

# Agregar remote (REEMPLAZA TU_USUARIO con tu usuario de GitHub)
git remote add origin https://github.com/TU_USUARIO/ExtractReq.git
...
**Backend:**
```bash
cd "C:\Users\SAMUEL\Documents\XII CICLO\Desarrollo de Tesis Final\ExtractReq\Backend"
git init
git add .
git commit -m "Initial commit - Backend"
git remote add origin https://github.com/TU_USUARIO/ExtractReq-Backend.git
git branch -M main
git push -u origin main
```
...
**Frontend:**
```bash
cd "C:\Users\SAMUEL\Documents\XII CICLO\Desarrollo de Tesis Final\ExtractReq\Frontend"
git init
git add .
git commit -m "Initial commit - Frontend"
git remote add origin https://github.com/TU_USUARIO/ExtractReq-Frontend.git
git branch -M main
git push -u origin main
```
...
# Busca la línea:
github_repo = "https://github.com/TU_USUARIO/ExtractReq.git"

# Reemplaza TU_USUARIO con tu usuario real de GitHub
# Ejemplo:
github_repo = "https://github.com/SamuelSoto7/ExtractReq.git"
...
```powershell
# Navega a terraform
cd "C:\Users\SAMUEL\Documents\XII CICLO\Desarrollo de Tesis Final\ExtractReq\terraform"
